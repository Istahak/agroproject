import {
  TreeView
} from "./chunk-334MG2CO.js";
import {
  ListBase,
  Sortable,
  cssClass,
  moveTo
} from "./chunk-DWY2YJKP.js";
import {
  Input,
  TextBox
} from "./chunk-2G6VOQIG.js";
import {
  Popup,
  createSpinner,
  getZindexPartial,
      ...
      if (li && li.length || this.enableVirtualization && !state) {
        ...
        if (!beforeSelectArgs.preventSelectEvent) {
          if (this.enableVirtualization) {
            if (state) {
              ...
              if (this.virtualSelectAllData instanceof Array) {
                for (var i = 0; i < this.virtualSelectAllData.length; i++) {
                  if (li[this.skeletonCount + i]) {
                    ...
                    this.updateListSelection(li[this.skeletonCount + i], event2, length - i);
                  } else {
                    if (this.fields) {
                      ...
                      if (this.value && value_3 != null && Array.isArray(this.value) && (!this.allowObjectBinding && this.value.indexOf(value_3) < 0 || this.allowObjectBinding && !this.isObjectInArray(value_3, this.value))) {
                        this.dispatchSelect(value_3, event2, null, false, length);
                      }
                    }
                  }
                }
              ...
              while (index_2 < this.value.length && index_2 <= 50 && index_2 < count_1 && this.value.length > 0) {
                this.removeValue(this.value[index_2], event2, this.value.length - index_2);
                index_2++;
              }
              if (length > 50) {
                setTimeout(function() {
                  while (index_2 < _this.value.length && index_2 < count_1 && _this.value.length > 0) {
                    _this.removeValue(value[index_2], event2, _this.value.length - index_2);
                    index_2++;
                  }
          ...
          for (var i_1 = 0; i_1 < li.length && i_1 < count_1; i_1++) {
            ...
            var mainElement = this.mainList ? this.mainList.querySelectorAll(state ? 'li.e-list-item:not([aria-selected="true"]):not(.e-reorder-hide)' : 'li.e-list-item[aria-selected="true"]:not(.e-reorder-hide)')[i_1] : null;
            if (state) {
              ...
              this.removeAllItems(value_5, event2, false, li[i_1], mainElement);
            }
            if (this.enableGroupCheckBox) {
...
//# sourceMappingURL=chunk-VMFJTZH3.js.map
